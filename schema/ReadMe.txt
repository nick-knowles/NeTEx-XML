...
Change List
     - 2016.07.22 v 1.04
			- Cleaning of the repository (one single version of each file, no more versioned forlder, etc.)
     ...
     - 2015.11.24 v 1.03
			- Add RequiresAccount  to CoditionSUmmary in NeTEx Fare Condition SUmmary Product 
